...
void gRenderer::init() {
	...
	colorshader = std::make_unique<gShader>();
	...
	textureshader = std::make_unique<gShader>();
	...
	imageshader = std::make_unique<gShader>();
	...
	gridshader = std::make_unique<gShader>();
...
gShader* gRenderer::getColorShader() {
	return colorshader.get();
}

gShader* gRenderer::getTextureShader() {
	return textureshader.get();
}

gShader* gRenderer::getFontShader() {
	return fontshader.get();
}
