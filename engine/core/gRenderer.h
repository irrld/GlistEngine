...
protected:
	...
	std::unique_ptr<gShader> fontshader;
	std::unique_ptr<gShader> imageshader;
	std::unique_ptr<gShader> skyboxshader;
	std::unique_ptr<gShader> shadowmapshader;
	std::unique_ptr<gShader> pbrshader;
	std::unique_ptr<gShader> equirectangularshader;
	std::unique_ptr<gShader> irradianceshader;
	std::unique_ptr<gShader> prefiltershader;
	std::unique_ptr<gShader> brdfshader;
	std::unique_ptr<gShader> fboshader;
	std::unique_ptr<gShader> gridshader;
